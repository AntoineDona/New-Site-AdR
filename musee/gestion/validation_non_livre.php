...
<head>
	...
	<title>Commandes non traité</title>
    ...
    <meta http-equiv="refresh" content="1.5;url=traite.php" /> <!--on redirige au bout de 3 secondes vers les commandes traitées-->
...
<div class="jumbotron text-center" style="margin-top:2rem;background-color:white;font-size:2rem;width:90%;margin-left:auto;margin-right:auto;">
    ...
    <p>
        La commande a bien été placée dans la catégorie "Commande non-traitée".
    </p>
</div>
