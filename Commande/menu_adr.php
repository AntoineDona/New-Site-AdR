...
*/
				...
				while ($categorie = $categories->fetch()) {
					...
					if ($categorie['id'] == 2) {
						...
						{
				?>
							<input value="checked" type="checkbox" class="article" name=<?php echo $article["id"]; ?> id=<?php echo $article["type_id"]; ?> <?php if ($article['stock'] == 'oui') {
						...
						{
						?>
							<input value="checked" type="checkbox" class="article" name=<?php echo $article["id"] ?> <?php if ($article['stock'] == 'oui') {
																															echo "checked=\"checked\"";
