...
<?php include("../included/header.php"); ?>
    ...
    <div class="carte">
        <form method="POST" action="validation_menu_adr.php" class="form_menu">
                        ...
                        <ul>
                            ...
                            ?>
                                    <li>
                                        ...
                                        <div class="price">
                                            <label class="soldout_label" for=<?php echo 'categorie_' . $article["type_id"]; ?>>Sold out?</label>
                                ...
                                ?>
                                    <li>
                                        <div class="article">
                                            ...
                                            <label for="article"><?php echo $article["article"]; ?></abel>
                                                <br>
                                                <span class="ingredients">
                                                    <?php echo $article['infos']; ?>
                                                </span>
            ...
            <label for="valider">Valider les modifs </label>
