...
if (number_place($pdo) < $_SESSION["total_places"]) {
	if ($_SESSION["isConnected"]) {
		...
		header("Location: /indiananones/connexion.php");
	}
}
if ($_SESSION['shotgun']) {
	header("Location: /indiananones/index.php");
...
<body>
	<div class="soldout_ctnr">
		...
		<p> Désolé <?php echo $_SESSION["prenom"]; ?>, le monde appartient à ceux qui se lèvent tôt... <br />
			Vérifie si tu as shotgun en cliquant sur recharger :
		</p>
		<div class="btns_ctnr">
			<div href="#" onClick="window.location='index.php'" id="reload">Recharger <i class="fa-sharp fa-solid fa-arrow-rotate-left fa-spin fa-spin-reverse"></i></div>
			<div href="#" onClick="window.location='logout.php'" id="reload">Se déconnecter <i class="fa-sharp fa-solid fa-right-from-bracket fa-fade"></i></div>
		</div>
	</div>
