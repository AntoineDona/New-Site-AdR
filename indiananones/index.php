...
if ($_SESSION["email"] == '???') {
	header("Location: /indiananones/troll.php");
}
...
if (number_place($pdo) >= $_SESSION['total_places'] and !$_SESSION['shotgun']) {
	if ($_SESSION["isConnected"]) {
		header("Location: /indiananones/fini.php");
	} else {
...
<body onload="onLoad()">
<div id="titreNanhorreur"><img src="img/titre.png" alt="IndiaNanones" style="height:100%"></div>
<div id="sg_link_ctnr">
	...
	<div id="counter">
		...
		<?php
			if (!$_SESSION['shotgun']) {
				...
				echo '<div id="qrLink"><a  href="/indiananones/QRgenerator.php" >Voir mon QR code</a> <i class="fa-sharp fa-solid fa-qrcode fa-beat"></i></div>';
			}
			?>
